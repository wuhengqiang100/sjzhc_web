<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.title" placeholder="请输入用户名称" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />

      <el-select v-model="listQuery.useFlag" placeholder="启用状态" clearable class="filter-item" style="width: 130px">
    ...
    >
      <el-table-column label="登陆id" prop="id" sortable="custom" align="center" :class-name="getSortClass('id')">
      ...
      <el-table-column label="登陆名" align="center" min-width="120px">
        <template slot-scope="{row}">
          <span class="link-type" @click="handleUpdate(row)">{{ row.loginName }}</span>
        </template>
      </el-table-column>
      <el-table-column label="登陆密码" min-width="200px" align="center">
        <template slot-scope="{row}">
      ...
      <el-table-column label="工作状态" align="center">
        <template slot-scope="{row}">
          <el-tag v-if="row.userInWork" type="success">
            在线
          </el-tag>
